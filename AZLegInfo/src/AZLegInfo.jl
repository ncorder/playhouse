...
export getSessions, getBillId, getBillInfo, getBillPositions_JSON, getSession57HouseLegislatureMemberVotingHistory
export var"57SessionHouseLegislatureMemberVotingHistory"
...
function getSession57HouseLegislatureMemberVotingHistory(
    ...
    Every .pdf in the zip, in any folder, is read with the nested
    extract_voting_history, which uses the nested extract_tables_from_pdf
    (Tabula) to read the PDF.
...
var"57SessionHouseLegislatureMemberVotingHistory" = getSession57HouseLegislatureMemberVotingHistory
